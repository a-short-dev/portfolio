...
| **Novoct Planet**  | Next.js, Prisma, PostgreSQL                        | Premium fashion e-commerce with full catalog and checkout system. |
| **Canwee Apartments** | Next.js, Prisma, PostgreSQL                     | Luxury short-let property management and booking platform. |
| **Flexiti**        | Next.js, Prisma, PostgreSQL                        | Licensed consumer finance platform for personal and business loans. |
| **UVO**            | Next.js, Prisma, PostgreSQL                        | Digital billboard advertising platform with booking system. |
