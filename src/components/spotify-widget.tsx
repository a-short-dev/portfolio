	...
	if (!isExpanded) {
		return (
			<div className="fixed bottom-6 left-6 z-50">
				<button
					type="button"
					className="bg-black border border-white/10 transition-all duration-500 cursor-pointer shadow-2xl w-14 h-14 rounded-full flex items-center justify-center hover:border-[#1DB954] hover:scale-105 group outline-none"
